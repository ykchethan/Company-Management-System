...
/**
 * Servlet implementation class employeeviewdocumentscont
 */
@WebServlet("/employeeviewdocumentscont")
public class employeeviewdocumentscont extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public employeeviewdocumentscont() {
        super();
